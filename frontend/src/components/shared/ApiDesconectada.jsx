      ...
      <Modal style={styles.card}>
        ...
        <div style={styles.buttonContainer}>
          <button 
            ...
            onMouseEnter={(e) => {
              e.target.style.boxShadow = "0 10px 15px -3px #5ebcff, 0 4px 6px -2px #5ebcff";
            }}
            onMouseLeave={(e) => {
              e.target.style.boxShadow = "0 4px 6px -1px #977ef3, 0 2px 4px -1px #977ef3";
            }}
          >
            Reiniciar
          </button>
          <button 
            ...
            onMouseEnter={(e) => {
              ...
              e.target.style.boxShadow = "0 10px 15px -3px #bebdbd, 0 4px 6px -2px #bebdbd";
            }}
            onMouseLeave={(e) => {
              e.target.style.backgroundColor = "#dadada";
              e.target.style.boxShadow = "0 4px 6px -1px #bebdbd, 0 2px 4px -1px #bebdbd";
            }}
          >
            Fechar
          </button>
