  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.cabecalhoNotaGrande}>
        ...
        <Image src={logo} style={styles.logoImpresa} />
        <View>
          <Text>
            CNPJ: {format.formatCNPJ(dadosLoja.cnpj || "00000000000000")}
          </Text>
      ...
      <View style={styles.boxInfo}>
        ...
        <Text>
          Data: {format.formatarDataCurta(venda.data_venda) || "Desconhecido"}
        </Text>
      </View>
      ...
      <View style={styles.table}>
        ...
        {produtos.map((product, index) => (
          <View style={styles.tableRow} key={index}>
            ...
            <Text style={styles.tableCol}>
              {format.formatarCurrency(product.valor_total)}
            </Text>
          </View>
        ))}
      </View>
      ...
      <View style={styles.preFooter}>
        ...
        <Text>Valor Total: {format.formatarCurrency(venda.valor_total)}</Text>
      </View>
